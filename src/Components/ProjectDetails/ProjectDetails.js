...
const ProjectDetail = () => {
    ...
    const { name, id, type, screenshots, description, detailedDescription, links } = project;
                ...
                <div className='flex flex-col'>
                    {
                        screenshots.map(screenshot => <>
                            <img
                            key={id}
                                src={`${screenshot.image}`} className="max-w-sm rounded-lg shadow-2xl" alt='screenshot' />
